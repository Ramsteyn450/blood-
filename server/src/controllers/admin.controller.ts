...
export const getStats = async (_req: AuthRequest, res: Response): Promise<void> => {
  try {
    ...
    const [totalUsers, activeDonors, ineligibleUsers, pendingRequests, acceptedRequests, totalDonations, totalReports, communityMessages] = await Promise.all([
    ...
    res.json({ success: true, stats: { totalUsers, activeDonors, ineligibleUsers, pendingRequests, acceptedRequests, totalDonations, totalReports, communityMessages } });
